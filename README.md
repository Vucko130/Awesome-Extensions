...
- **Bitwarden Password Manager** - At home, at work, or on the go, Bitwarden easily secures all your passwords, passkeys, and sensitive information.
  - [For Chrome](https://chromewebstore.google.com/detail/bitwarden-free-password-m/nngceckbapebfimnlniiiahkandclblb)
  - [For Firefox](https://addons.mozilla.org/en-US/firefox/addon/bitwarden-password-manager/)
...
- **Sidebery** - Vertical tabs tree and bookmarks in sidebar with advanced containers configuration, grouping and many other features.
  - [For Chrome](https://chromewebstore.google.com/detail/vertical-tabs-in-side-pan/akahnknmcbmgodngfjcflnaljdbhnlfo)
  - [For Firefox](https://addons.mozilla.org/en-US/firefox/addon/sidebery/)
...
- **ClearURLs** - Remove tracking elements from URLs.
  ...
  - [For Firefox](https://addons.mozilla.org/en-US/firefox/addon/clearurls/)
